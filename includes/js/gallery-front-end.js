jQuery(document).ready(function($) {
	...
	var retina_multiplier = 1;
	
	
	if ( row_height < (75/retina_multiplier) ){
		var url_size = "_s";
	}
	if ( row_height < (150/retina_multiplier) ){
		var url_size = "_q";
	}
	...
	else if ( row_height < (500/retina_multiplier) ){
		var url_size = "_-";
	}
    ...
    var tags = "rock";
	//$.getJSON("http://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=dbb49a0e2dcc3958834f1b92c072be62&tags=" + tags + "&tag_mode=all&sort=interestingness-desc&extras=url_c&format=json&jsoncallback=?", null, 
	
	$.getJSON("http://api.flickr.com/services/rest/?format=json&extras=url"+url_size+"&method=flickr.photosets.getPhotos&photoset_id=72157635004120758&api_key=dbb49a0e2dcc3958834f1b92c072be62&jsoncallback=?", null,
